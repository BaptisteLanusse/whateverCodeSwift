...
struct Five100px {
    enum Router: URLRequestConvertible {
        ...
        static let consumerKey = "yW8EvSkInWIqPRqLLxMTmTnaO8STcLUNeo0hu74M"
        ...
        var URLRequest: NSURLRequest {
            let (path: String, parameters: [String: AnyObject]) = {
                ...
                case .PopularPhotos (let page):
                    let params = ["consumer_key": Router.consumerKey, "page": "\(page)", "feature": "popular", "rppp": "50", "include_store": "store_download", "include_states": "votes"]
