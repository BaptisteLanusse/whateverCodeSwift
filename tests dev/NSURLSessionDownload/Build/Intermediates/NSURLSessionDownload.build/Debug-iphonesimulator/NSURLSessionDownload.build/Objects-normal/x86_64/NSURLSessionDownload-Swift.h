...
SWIFT_CLASS("_TtC20NSURLSessionDownload11AppDelegate")
...
SWIFT_CLASS("_TtC20NSURLSessionDownload18CircularLoaderView")
@interface CircularLoaderView : UIView
@property (nonatomic, readonly) CAShapeLayer * __null_unspecified circlePathLayer;
...
- (void)configure;
- (CGRect)circleFrame;
- (UIBezierPath * __nonnull)circlePath;
- (void)layoutSubviews;
@end
...
SWIFT_CLASS("_TtC20NSURLSessionDownload14ViewController")
...
@property (nonatomic) UIView * __null_unspecified downloadView;
@property (nonatomic) CircularLoaderView * __nonnull progressIndicatorView;
- (void)viewDidLoad;
